...
The agent reviews the conversation and relevant existing outputs. It writes an evidence ledger and fills a fixed A4 card with derived counts, a knowledge storage chart, a short insight and concrete examples. It can report that everything was saved, or that storage could not be checked. Knowledge found only in the chat is not automatically proof of forgetting.
